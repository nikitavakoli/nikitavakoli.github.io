...
<hr>
<p style="font-size:16px"> As an engineering student, I possess technical skills that allow me to understand data and conduct meaningful research. I mainly program in Python and MATLAB, although I also have experience with C for high-performance computing, SQL for databases, and HTML5/CSS3. My data analysis toolkits include packages such as Pandas, NumPy, Matplotlib, and SciKit-Learn/Tensorflow in Python. I also have experience working in the Google cloud. My coursework during my undergraduate and graduate career spans from core classes in Mathematics, the Sciences, and Biomedical Engineering.
<hr>
